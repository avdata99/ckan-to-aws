...
- **AWS Session Manager plugin**: Required for `ecs-exec.sh` (interactive shell into containers). See [SSH into Containers](#ssh-into-containers-ecs-exec) for install instructions.
