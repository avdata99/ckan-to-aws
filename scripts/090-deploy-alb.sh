...
echo "Next steps:"
echo "1. Deploy Solr + Redis services: ./scripts/091-deploy-services.sh"
echo "2. Get service URLs and rebuild CKAN image"
echo "3. Deploy CKAN service: ./scripts/092-deploy-ckan.sh"
echo "========================================"
